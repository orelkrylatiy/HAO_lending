      ...
      <div className="container-main py-6 md:py-10">
        <div className="bg-[#FFE9D2] rounded-[28px] md:rounded-[36px] overflow-hidden relative animate-fade-up">
          <div className="flex flex-col lg:flex-row">
            <div className="flex-1 px-7 pt-8 pb-4 md:px-12 lg:px-14 md:pt-12 md:pb-12 flex flex-col justify-between min-h-[420px] lg:min-h-[520px]">
              ...
              <div className="flex flex-col gap-4 max-w-[560px] animate-fade-up-delay-2">
                <OpenSignupButton className="button-lift relative z-10 flex items-center justify-between gap-4 bg-[#F86704] text-white font-bold text-[17px] md:text-[21px] px-7 py-4 md:py-5 rounded-2xl hover:bg-[#e55a1f] transition-colors shadow-sm">
            ...
            <div className="relative flex-1 flex flex-col lg:flex-row items-center justify-end overflow-hidden min-h-[300px] lg:min-h-[520px] px-4 lg:px-0 pt-4 lg:pt-0 pointer-events-none">
              ...
              <Image
                ...
                width={762}
                height={421}
                className="animate-soft-float block w-full max-w-[360px] sm:max-w-[460px] md:max-w-[660px] lg:max-w-[700px] h-auto object-contain object-bottom lg:-mr-7"
                priority
              />
            </div>
          </div>
